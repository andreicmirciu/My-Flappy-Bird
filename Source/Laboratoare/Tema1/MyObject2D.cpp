...
Mesh* MyObject2D::CreateTriangle(std::string name, std::vector<VertexFormat> vertices, std::vector<unsigned short> indices)
{
...
Mesh* MyObject2D::CreateCircle(std::string name, glm::vec3 center, float radius, glm::vec3 color)
{
...
Mesh* MyObject2D::CreateBird(std::string name) 
{
	std::vector<VertexFormat> vertices =
	{
...
Mesh* MyObject2D::CreateRectangle(std::string name, std::vector<VertexFormat> vertices, std::vector<unsigned short> indices)
{
...
Mesh* MyObject2D::CreateCloud(std::string name) {
	std::vector<VertexFormat> vertices =
	{
